                ...
                <div className={style.feedback_box}>
                    <form id="feedbackForm" onSubmit={handleSubmit}>
                        ...
                        <div className={style.wrap}>
                            <button type="reset" id="reset_button" className={style.cancel} onClick={handleFormReset}>
                                {t("reset_btn")}
                            </button>
                            <br />
                            <button type="submit" id="submit_button" data-testid="test_submit" className={style.submit} name="submit_button">
                                {t("submit_btn")}
                            </button>
                        </div>
                    </form>
